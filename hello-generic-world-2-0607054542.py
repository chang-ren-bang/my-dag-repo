...
args = {
    "project_id": "hello-generic-world-2-0607054542",
}

dag = DAG(
    "hello-generic-world-2-0607054542",
    default_args=args,
...
op_0a1b4861_a7b3_4b5c_a1be_8f2f0fb25d88 = PapermillOperator(
    ...
    input_nb="examples/pipelines/run-generic-pipelines-on-apache-airflow/Part 1 - Data Cleaning.ipynb",
    output_nb="examples/pipelines/run-generic-pipelines-on-apache-airflow/Part 1 - Data Cleaning_out.ipynb",
    parameters={},
    kernel_name="",
    dag=dag,
)
...
op_0cb3a3d9_a185_425a_8f32_0bb85a5dd819 = PapermillOperator(
    ...
    input_nb="examples/pipelines/run-generic-pipelines-on-apache-airflow/Part 2 - Data Analysis.ipynb",
    output_nb="examples/pipelines/run-generic-pipelines-on-apache-airflow/Part 2 - Data Analysis_out.ipynb",
    parameters={},
    kernel_name="",
    dag=dag,
)
...
op_ad0925be_c5a3_4551_bdf0_2e6240299cb7 = PapermillOperator(
    ...
    input_nb="examples/pipelines/run-generic-pipelines-on-apache-airflow/Part 3 - Time Series Forecasting.ipynb",
    output_nb="examples/pipelines/run-generic-pipelines-on-apache-airflow/Part 3 - Time Series Forecasting_out.ipynb",
    parameters={},
    kernel_name="",
    dag=dag,
)
