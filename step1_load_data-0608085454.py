...
args = {
    "project_id": "step1_load_data-0608085454",
}

dag = DAG(
    "step1_load_data-0608085454",
    default_args=args,
...
op_ac8738d1_42e1_4a83_b413_dcf8991cd77b = PapermillOperator(
    task_id="load_data",
    input_nb="~/work/examples/pipelines/run-generic-pipelines-on-apache-airflow/load_data.ipynb",
    output_nb="~/work/examples/pipelines/run-generic-pipelines-on-apache-airflow/load_data_out.ipynb",
    parameters={},
    kernel_name="",
    dag=dag,
)
